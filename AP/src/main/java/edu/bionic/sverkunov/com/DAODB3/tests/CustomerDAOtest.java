...
public class CustomerDAOtest {
	private static final String UNIT_NAME = "DB4";
	...
	public void test1(){
		...
		List<Dish> menusection = dao.selectMenusection(3);
	...
	public void test3(){
		...
		CustomerDAO dao = new CustomerDAO();
//		int orderNumber1 =  dao.submitOrder(dishes, customer);
